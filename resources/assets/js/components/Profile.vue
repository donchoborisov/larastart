        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header text-white" style="background-image:url('./img/image.jpg')">
                            ...
                            <div class="tab-pane active show" id="settings">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="password" name="password" v-model="form.password" id="password" placeholder="Passport" class="form-control" :class="{ 'is-invalid': form.errors.has('password') }">
